import { Mail, Phone, MapPin, Globe, Share2, ExternalLink, Rss } from 'lucide-react';
import { Link } from 'react-router-dom';
import logo from '../assets/logo.png';

const socialIcons = [Globe, Share2, ExternalLink, Rss];
...
/* Use explicit bg color so it's guaranteed regardless of Tailwind class generation */
    ...
    <footer style={{ backgroundColor: FOOTER_BG, marginTop: '4rem' }} className="text-white">
      <div className="container-custom pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              Transforming African agriculture through strategic consulting. Building sustainable
              food systems and empowering value chains across the continent.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300 text-sm mb-7">
              <li className="flex items-center gap-2.5">
                ...
                <a href="tel:+33746332937" className="hover:text-orange-accent transition-colors">
                  +33 7 46 33 29 37
                </a>
              </li>
              <li className="flex items-center gap-2.5">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="mailto:info@agrohelp.com" className="hover:text-orange-accent transition-colors">
                  info@agrohelp.com
                </a>
              </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 text-sm text-gray-400">
          <p>&copy; 2026 AgroHelp Group. All rights reserved.</p>
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            <a href="#" className="hover:text-orange-accent transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-orange-accent transition-colors">Terms of Service</a>
            <Link to="/contact" className="hover:text-orange-accent transition-colors">Contact Us</Link>
          </div>
        </div>
      </div>
    </footer>
