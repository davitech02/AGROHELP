...
const team = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1534528741775-53994a69be16?w=500&h=600&fit=crop&q=80',
  },
];
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="section-subtitle max-w-2xl mx-auto">
            Meet the dedicated experts driving agricultural transformation across Africa
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="relative h-72 overflow-hidden bg-gray-100">
                ...
                <div className="absolute inset-0 bg-deep-green/0 group-hover:bg-deep-green/40 transition-all duration-400 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100">
                  <a
                    href="#"
                    className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center shadow-lg hover:bg-orange-accent hover:text-white transition-colors duration-200"
                  >
              ...
              <div className="p-5 text-center">
                ...
                <p className="text-orange-accent font-semibold text-sm">{member.role}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
